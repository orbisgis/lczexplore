...
showLCZ(sf=redonOSM,wf="OSM",column="LCZ_PRIMARY",repr="alter", LCZlevels = LCZlevels)
```
...
LCZlevels<-c(2, 3, 5, 6, 8, 9, 101, 102, 104, 105, 107)
showLCZ(sf=redonOSM,wf="OSM",column="LCZ_PRIMARY",repr="alter",drop=TRUE, LCZlevels = LCZlevels)
