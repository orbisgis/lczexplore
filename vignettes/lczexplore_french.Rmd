...
redonOSM<-importLCZgen(dirPath=dirPath,file="rsu_lcz_osm_redon.geojson",column = "LCZ_PRIMARY")
redonBDT<-importLCZgen(dirPath=dirPath,file="rsu_lcz_bdt_redon.geojson",column = "LCZ_PRIMARY")
#
```
...
showLCZ(sf=redonOSM,wf="OSM",column="LCZ_PRIMARY",repr="brut",niveaux="",colors="")
```
...
showLCZ(sf=redonOSM,wf="OSM",column="LCZ_PRIMARY",repr="grouped",niveaux=niveaux,colors=couleurs)
...
On peut alors l'affecter à l'argument column de showLCZ pour représenter les nouveaux groupes de niveaux, en reprenant le nom de ces groupes comme niveaux et le vecteurs de couleurs pour l'argiment colors. 
...
Efin, si l'argument `exwrite=TRUE` la fonction compareLCZ exporte les données qui ont servi à produire la matrice de confusion dans un fichier csv. Ce fichier peut ensuite être chargé dans R pour d'autres analyses. 
...
redonBDT<-importLCZgen(dirPath=dirPath,file="rsu_lcz_bdt_redon.shp", 
...
```{r}
redonCompare<-compareLCZ(sf1=redonBDT,wf1="bdt", geomID1 = "ID_RSU",column1 ="LCZ_PRIMAR",
                         confid1 = "LCZ_UNIQUE",
...
confidSensib(file=redonCompare$data,filePath="", nPoints=10,
             wf1="bdtopo_2_2", wf2="osm",
             geomID1="ID_RSU", column1="LCZ_PRIMAR", confid1="LCZ_UNIQUE",
             geomID2="ID_RSU.1",column2="LCZ_PRIMARY", confid2="LCZ_UNIQUENESS_VALUE",
             sep=";", repr="brut",
             niveaux="", plot=TRUE)
