...
a layer of confidence value. This allows to also perform a confidence analysis on the agreement between two maps according to the level of confidence one allows to the LCZ value for each pixel. 
...
comparisonSidney<-compareLCZ(sf1=sidneyOSM,column1="LCZ_PRIMARY", wf1="BD TOPO v2.2",
                             sf2=sidneyWudapt,column2="LCZraster",wf2="Open Street Map", ref=1,
                             repr="standard",exwrite=F, location="Redon")

confidRedon<-confidSensib(inputDf=comparaisonSidney$data,filePath="", nPoints=5,
