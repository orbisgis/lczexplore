...
3. A confusion matrix, to explore how the levels of one classification break up in levels of the other classification, shown in a graphical way to help visualize the main difference between the classifications.
...
It is sometimes useful to group some LCZ levels, for instance group the urban LCZ types together and the rural LCZ types under another category, or group the levels one consider as sensitive on an urban heat island point of view. The package allows the user to specify the LCZ levels to group together and the corresponding colors.
...
As you can specify the expected levels on grouped LCZ for the main functions of lczexplore, you can use them to compare any pair of qualitative variables available on the same area. For readability reason, we limited the number of possible levels of these variables to thirty-six.
