...
sfList<-list(BDT22 = sfBDT_22_78030, OSM22 = sf_OSM_22_Auffargis,
             WUDAPT = sf_WUDAPT_78030)
# showLCZ(sfList[[1]])



intersected<-createIntersect(sfList = sfList, columns = c(rep("LCZ_PRIMARY",2),"lcz_primary"),
                             sfWf = c("BDT22","OSM22","WUDAPT"), minZeroArea=0.1)
