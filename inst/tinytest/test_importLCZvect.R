...
redonBDT2<-importLCZvect(dirPath=paste0(
  system.file("extdata", package = "lczexplore"), "/multipleWfs/Redon"), file = "bdt_lcz.fgb",
...
expect_error(importLCZvect(dirPath=paste0(
  system.file("extdata", package = "lczexplore"),"/multipleWfs/Redon"), file="chaussure.geojson",
  column="LCZ_PRIMARY",geomID="ID_RSU",confid="LCZ_UNIQUENESS_VALUE"),"The file doesn't seem to exist.")

## Error if directory doesn't exist

expect_error(importLCZvect(dirPath=paste0(
  system.file("extdata", package = "lczexplore"), "/multipleWfs/Clohars-Carnoët"), file="bdt_lcz.fgb",
  column="LCZ_PRIMARY", geomID="ID_RSU", confid="LCZ_UNIQUENESS_VALUE"),
...
expect_error(
  importLCZvect(dirPath=paste0(
    system.file("extdata", package = "lczexplore"),"/multipleWfs/Redon"), file="bdt_lcz.fgb", column="",
...
#   system.file("extdata", package = "lczexplore"),"/multipleWfs/Redon"),file="rsu_lcz.geojson",column="LCZ_PRIMARY",
...
expect_warning(importLCZvect(dirPath=paste0(system.file("extdata", package = "lczexplore"), "/multipleWfs/Redon"),
             file="bdt_lcz.fgb", output="sfFile", column="LCZ_PRIMARY",
             geomID="", confid="",
