...
#' of a geographical dataset (tested : geojson, shp, more to come)
#'
...
#' @export
#' @examples importSurfQualVar(dirPath=paste0(system.file("extdata", package = "lczexplore"),
#' "/bdtopo_2_2/Redon"), file="rsu_utrf_area.geojson", column="TYPO_MAJ",
...
if(typeLevels=""){
  typeLevels<-as.character(unique((st_drop_geometry(subset(sfFile,select=column,drop=T))))) } else { 
